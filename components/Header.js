    ...
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 
            ...
            <div className="flex items-center rounded-full py-2 
                ...
                <input placeholder={placeholder || "Start your search"} onChange={e=>handleSearchTerm(e)} value={searchTerm} className="pl-5 outline-none text-sm text-gray-600 placeholder-gray-400
                    bg-transparent flex-grow" type="text" />
            ...
            {open && (
                <div className="flex flex-col col-span-3 mx-auto">
                    ...
                    <div className="flex">
                        <button onClick={resetSearch} className="flex-grow text-gray-500">Cancel</button>
